...
use Medeiros\TesteBundle\Entity\paciente;
...
class pacienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pacientes = $em->getRepository('MedeirosTesteBundle:paciente')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Medeiros\TesteBundle\Form\pacienteType', $paciente);
    ...
    {
        $deleteForm = $this->createDeleteForm($paciente);
        $editForm = $this->createForm('Medeiros\TesteBundle\Form\pacienteType', $paciente);
